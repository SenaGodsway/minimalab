...
const Footer = () => {
  return (
    ...
    <h1 className="text-4xl mb-6 font-bold"> Lets get connected</h1>
      <div className='grid grid-cols-2 items-center justify-center gap-8 md:flex md:flex-row md:gap-12'>
        ...
        {/* Twitter/X */}
        <div className='flex items-center gap-3 border-2 px-4 py-2 rounded transition-colors hover:text-black'>
        ...
        {/* Instagram */}
        <div className='flex items-center gap-3 border-2 px-4 py-2 rounded transition-colors hover:text-pink-600'>
        ...
        {/* YouTube */}
        <div className='flex items-center gap-3 border-2 px-4 py-2 rounded transition-colors hover:text-red-600'>
        ...
        {/* LinkedIn */}
        <div className='flex items-center gap-3 border-2 px-4 py-2 rounded transition-colors hover:text-blue-700'>
